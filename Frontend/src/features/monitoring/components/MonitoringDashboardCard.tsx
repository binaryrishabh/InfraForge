...
// Hex values so alpha can be appended for the glowing chip background + dot.
...
export const MonitoringDashboardCard = memo(function MonitoringDashboardCard({
  ...
  // ---- Declared capacity (design-mode hero + fallback) ----
  ...
  // ---- Hero metric: declared capacity (design) or live RPS (live) ----
    ...
    >
      ...
      <div className="flex items-center justify-between mb-1">
        <div className="flex items-center gap-2 min-w-0">
          ...
          >
            <ResourceIcon type={resource.type} size={16} className="" />
          </span>
        ...
        <span
          className={`flex items-center gap-1.5 text-[9px] font-mono uppercase font-semibold px-2 py-0.5 rounded-full border ${chipStyle.text} ${chipStyle.border}`}
      ...
      <div className="flex items-baseline gap-1.5 mb-2">
        <span className="text-[20px] font-mono font-semibold text-[#EDF1F7] tabular-nums leading-none">
      ...
      {mode === "design" ? (
        <>
          ...
          {/* Sparkline — threshold gridlines read as the subtle design baseline */}
        ...
        <>
          ...
          <div className="mb-1">
            ...
            <div className="h-0.5 rounded-full bg-[#1F2633] overflow-hidden">
              <div
          ...
          {/* Chaos accent strip */}
          {chaosEffect && (
            <div className="mt-2 -mx-3 -mb-3 px-3 py-1.5 rounded-b-xl bg-[rgba(240,86,74,0.10)] border-t border-[rgba(240,86,74,0.35)] flex items-center justify-between">
  ...
  // Smoke wisps render OUTSIDE the overflow-hidden card body so they can rise
  // above the card when a resource fails.
