...
export const ResourceSidebar = memo(function ResourceSidebar() {
  return (
    // pt-20 keeps the first palette items clear of the floating topbar
    // (top-3 + 48px bar height + breathing room).
    <div className="w-16 h-full bg-gray-950 border-r border-gray-800 flex flex-col items-center gap-4 pt-20">
